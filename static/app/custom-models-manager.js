            ...
            tbody.innerHTML = `
                <tr>
                    <td colspan="6" class="table-empty-state">
                        ...
                        <div class="empty-text" data-i18n="customModels.noModels">${t('customModels.noModels')}</div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button class="icon-btn edit edit-model-btn" data-id="${model.id}" title="${t('customModels.editModel')}">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="icon-btn delete delete-model-btn" data-id="${model.id}" title="${t('customModels.deleteModel')}">
