...
function showCopyToast(modelName) {
    ...
    toast.innerHTML = `
        ...
        <span>${t('models.copied')}: ${modelName}</span>
    `;
    ...
    if (providerTypes.length === 0) {
        container.innerHTML = `
            <div class="models-empty">
                ...
                <p data-i18n="models.empty">${t('models.empty')}</p>
            </div>
        `;
        return;
    }
        ...
        html += `
            <div class="provider-models-group" data-provider="${providerType}">
                ...
                <div class="provider-models-content" id="models-${providerType}">
                    ${modelList.map(model => `
                        <div class="model-item" onclick="window.copyModelName('${escapeHtml(model)}', this)" title="${t('models.clickToCopy')}">
