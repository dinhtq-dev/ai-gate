...
import { getOAuthClientCredentials } from '../../auth/oauth-client-credentials.js';
...
const { clientId: OAUTH_CLIENT_ID, clientSecret: OAUTH_CLIENT_SECRET } = getOAuthClientCredentials('gemini-antigravity');
